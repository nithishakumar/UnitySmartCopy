...
{
    /// <summary>
    /// Provides a function to retrieve valid public properties' paths of a <see cref="SerializedObject"/>.
    /// Valid properties include public fields and private fields with [SerializeField] or [HideInInspector],
    /// while specifically ignoring the "m_Script" field.
    /// </summary>
    public static class ValidPublicProperties
    {
        private static readonly HashSet<string> PUBLIC_PROPERTIES_TO_IGNORE = new() { "m_Script" };

        // Code from: https://discussions.unity.com/t/serializedproperty-nextvisible-doesnt-work-with-hideininspector/801420/2
        private delegate FieldInfo FieldInfoGetter(SerializedProperty p, out Type t);

        /// <summary>
        /// Retrieves valid public properties of a <see cref="SerializedObject"/>. 
        /// Refer to <see cref="ValidPublicProperties"/> for the definition of a valid public property.
        /// </summary>
        /// <returns>
        /// A set containing the property paths of the valid public properties.
        /// </returns>
...
#endif
            var fieldInfoGetter =
                (FieldInfoGetter)Delegate.CreateDelegate(typeof(FieldInfoGetter), fieldInfoGetterMethod);

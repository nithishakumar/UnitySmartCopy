...
If the component is attached to the root prefab object and contains a self-reference (e.g., references a function on itself), Unity’s default Copy/Paste Component remaps the root reference to the target object. SmartCopy does not perform this remapping. Refer to the example below in 2 different cases.
